...
%Repita los puntos 1-5 para el caso b). Para ello incluya una extensión cíclica de longitud l_cp = 4 como intervalo de guarda.
...
%Repita los puntos 1-5 para el caso c). Para ello incluya una extensión cíclica de longitud l_cp = 16 como intervalo de guarda.
