...
BER_32APSK = BER_APSK([4, 12, 16], [1, 2.5], EbNo_dB);

graficaBER(EbNo_dB, [BER_4QAM; BER_16QAM; BER_64QAM; BER_256QAM], [BER_teor_4QAM; BER_teor_16QAM; BER_teor_64QAM; BER_teor_256QAM], ["4-QAM", "16-QAM", "64-QAM", "256-QAM"], "Nivel de error para diferentes modulaciones QAM")
graficaBER(EbNo_dB, [BER_4QAM; BER_16QAM; BER_64QAM; BER_256QAM; BER_16APSK], [BER_teor_4QAM; BER_teor_16QAM; BER_teor_64QAM; BER_teor_256QAM], ["4-QAM", "16-QAM", "64-QAM", "256-QAM", "16-APSK"], "Nivel de error para diferentes modulaciones y SNR")