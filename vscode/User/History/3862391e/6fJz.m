function decodedBits = fullReceiver(rxSignal, numCarriers, h, numSymbols, NFFT, pilotCarrier, cpLength, constellation, scramblerSeed, generatorPolys, doDeinterleave)
