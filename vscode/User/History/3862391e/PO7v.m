function decodedBits = fullReceiver(rxSignal, numCarriers, h, numSymbols, NFFT, firstCarrier, cpLength, constellation, pilotSequence, scramblerSeed, generatorPolys, doDeinterleave)
