...
disp('Symbols and their coefficients:');
for i = 1:2:length(bits)
    symbolIndex = (i + 1) / 2;
    fprintf('Symbol %d: Bits = [%d %d], dem1 = %d, dem2 = %d\n', symbolIndex, bits(i), bits(i+1), dem1(symbolIndex), dem2(symbolIndex));
end
...
xlabel('SNR [dB]')
ylabel('P_e')
title('Simulated and Theoretical Error Probability vs SNR')
