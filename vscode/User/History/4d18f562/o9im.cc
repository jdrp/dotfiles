...
RandomNoiseClient::RandomNoiseClient()
{
    ...
    m_normalRand->SetAttribute("Mean", m_packetSizeMean);
    m_normalRand->SetAttribute("Variance", m_packetSizeVariance);
    m_exponentialRand->SetAttribute("Mean", m_intervalMean);
}
...
RandomNoiseClient::Send()
{
    ...
    if (m_dataSize)
    {
        ...
        NS_ASSERT_MSG(m_dataSize == m_size,
                      "RandomNoiseClient::Send(): m_size and m_dataSize inconsistent");
        NS_ASSERT_MSG(m_data, "RandomNoiseClient::Send(): m_dataSize but no m_data");
