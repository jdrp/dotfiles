function BER = transceiverBlock(numFrames, symbolsPerFrame, pilotSequence, NFFT, firstCarrier, cpLength, m_ary, numCarriers, generatorPolys, scramblerSeed, constellation, h, snr)
    rng(40);
    ...
    for f = 1:numFrames
        ...
        % Transmitter
        txSignal = tx.fullTransmitter(bits, generatorPolys, scramblerSeed, numCarriers, symbolsPerFrame, constellation, NFFT, firstCarrier, cpLength, pilotSequence);
