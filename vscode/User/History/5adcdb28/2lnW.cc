...
interval_randomizer->SetAttribute ("Min", DoubleValue (0.1));
interval_randomizer->SetAttribute ("Max", DoubleValue (0.4));
...
for(int i = 1; i < nClients; i++){
  ...
  if (i == 1){
    echoClient.SetAttribute("PacketSize", UintegerValue(50000));
  }else{
    echoClient.SetAttribute("PacketSize", UintegerValue(50000));
  }
